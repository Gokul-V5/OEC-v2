...
public class PlanController : ControllerBase
{
    ...
    [HttpPost("AddProcedureUserToPlan")]
    public async Task<IActionResult> AddProcedureUserToPlan(UserAddProcedureToPlanCommand command, CancellationToken token)
    {
        var response = await _mediator.Send(command, token);
    ...
    [HttpPost("DeleteProcedureUserToPlan")]
    public async Task<IActionResult> DeleteProcedureUserToPlan(UserDeleteProcedureToPlanCommand command, CancellationToken token)
    {
        var response = await _mediator.Send(command, token);
